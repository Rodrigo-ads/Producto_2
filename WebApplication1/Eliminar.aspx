...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:DropDownList CssClass="form-select mt-2" ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList>
            <asp:DropDownList CssClass="form-select mt-2" ID="DropDownList2" runat="server"></asp:DropDownList>

            <asp:Button ID="Button1" CssClass="btn btn-primary mt-4" runat="server" Text="Eliminar Registro" OnClick="Button1_Click" />
